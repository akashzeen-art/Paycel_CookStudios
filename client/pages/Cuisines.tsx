...
export default function Styles() {
  ...
  const CookStyles = [
    ...
    },
    {
      ...
      emoji: "🤸",
      description: "Partner practice blending Cook and acrobatics",
  ...
  return (
    <div className="relative min-h-screen bg-food-cream">
      ...
      <div className="relative z-20">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-10">
              {[
                { id: 1, title: "Comfort Cooks", time: "00:33 mins", image: "🍲" },
                ...
                { id: 14, title: "Cook Love", time: "00:39 mins", image: "❤️" }
              ].map((video, index) => (
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-transparent">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-16 animate-slide-up">
              Discover Cook <span className="text-yellow-500">Traditions</span>
            </h2>
        ...
        {/* Street Cook Adventures */}
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-white text-center mb-12">
              Street Cook <span className="text-yellow-500">Adventures</span>
            </h2>
            <Carousel slidesToShow={5}>
              {[
