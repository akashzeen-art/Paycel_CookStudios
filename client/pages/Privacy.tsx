        ...
        <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md rounded-xl p-8 text-white">
            ...
            <div className="space-y-6 text-sm leading-relaxed">
              <p>This Privacy Policy describes how NumeroMobile ("we", "us", or "our") collects, uses, discloses, and protects your personal information when you visit or make a purchase from https://cookstudios.co.in/ (the "Site") or use any of our services (collectively, the "Services").</p>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">12. Governing Law and Jurisdiction</h2>
